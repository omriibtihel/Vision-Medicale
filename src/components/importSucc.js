...
import { faUser, faChartLine, faCog, faBrain, faDatabase, faFileAlt, faHistory, faRocket, faTimes } from '@fortawesome/free-solid-svg-icons';
...
const ImportSuccess = () => {
  ...
  const fetchTargetFeature = async () => {
    ...
    try {
      ...
      if (response.data.targetFeature) {
        setTargetFeature(response.data.targetFeature);
  ...
  const handleChange = (e) => setTargetFeature(e.target.value);
    ...
    <>
      <div className="menu-bar">
        ...
        <div className="menu-item" onClick={handleGraphsClick}>
          <FontAwesomeIcon icon={faChartLine} /> Graphs
        </div>
        <div className="menu-item" onClick={handleProcessingClick}>
          <FontAwesomeIcon icon={faCog} /> Processing
        </div>
        <div className="menu-item" onClick={handleModelsClick}>
          <FontAwesomeIcon icon={faBrain} /> Models
        </div>
        <div className="menu-item" onClick={handleDepClick}>
          <FontAwesomeIcon icon={faRocket} /> Deployment
        </div>
      </div>
      ...
      <div className="content1">
        ...
        <div className="description">
          ...
          {!isTargetFeatureSet && (
            <div>
              <select value={targetFeature} onChange={handleChange}>
                <option>Choose Target Feature</option>
          ...
          {isTargetFeatureSet && (
            <p><strong>Selected Target Feature:</strong> {targetFeature}</p>
          )}
        </div>
  ...
  {isFeaturePopupOpen && (
    <div className="feature-popup-box" onClick={(e) => e.stopPropagation()}>
      ...
      <div className="feature-buttons" style={{ marginTop: '1rem' }}>
        ...
        {/* Modal popup pour les graphiques */}
